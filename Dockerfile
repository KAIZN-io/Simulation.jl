...
# packages for web
RUN pip install --no-cache-dir "psycopg2-binary==2.7.7" "sqlalchemy==1.2.18" "Flask==1.0.2" "Flask-WTF==0.14.2" "uuid==1.30" "namesgenerator==0.3" "pika==0.13.0" "Flask-SocketIO==3.3.1" "eventlet==0.24.1"
